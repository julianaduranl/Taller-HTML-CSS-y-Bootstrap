...
let infoGeneral: HTMLElement = document.getElementById("infoGeneral") !;
let imagen: HTMLElement = document.getElementById("foto")!;
let link: HTMLElement = document.getElementById("link")!;
let titulo1: HTMLElement = document.getElementById("titulo1")!;
let titulo2: HTMLElement = document.getElementById("titulo2")!;
let titulo3: HTMLElement = document.getElementById("titulo3")!;
let titulo4: HTMLElement = document.getElementById("titulo4")!;
...
function mostrarDatosCantante(cantante:Cantante):void{
